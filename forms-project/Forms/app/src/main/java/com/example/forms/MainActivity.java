...
import com.example.forms.DataActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText editTextNome, editTextIdade, editTextCurso, editTextRA, editTextEmail;
    ...
    private void sendData() {
        ...
        if (ra.isEmpty() || ra.length()<8){
            Toast.makeText(MainActivity.this, "Preencha corretamente o campo RA, ele deve ter 8 digitos", Toast.LENGTH_SHORT).show();
            return;
        }
